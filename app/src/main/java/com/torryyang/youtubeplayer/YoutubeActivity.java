...
//        });
    ...
    private YouTubePlayer.PlaybackEventListener playbackEventListener = new YouTubePlayer.PlaybackEventListener() {
        ...
        public void onPlaying() {
            Toast.makeText(YoutubeActivity.this, "vid playing", Toast.LENGTH_LONG).show();
        }

        @Override
        public void onPaused() {
            Toast.makeText(YoutubeActivity.this, "vid paused", Toast.LENGTH_LONG).show();
        }
    ...
    YouTubePlayer.PlayerStateChangeListener playerStateChangeListener = new YouTubePlayer.PlayerStateChangeListener() {
        ...
        public void onAdStarted() {
            Toast.makeText(YoutubeActivity.this, "ad playing", Toast.LENGTH_LONG).show();
        }

        @Override
        public void onVideoStarted() {
            Toast.makeText(YoutubeActivity.this, "vid started", Toast.LENGTH_LONG).show();
        }
